                            ...
                            <div class="text-center mt-sm-5 mb-4 text-white-50">
                                <div>
                                    <a href="index.php" class="d-inline-block auth-logo">
                                        ...
                                        <span class="text-white">logito</span>
                                    </a>
                                </div>
                                <p class="mt-3 fs-15 fw-medium">Inventory-Flow</p>
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
                                ...
                                <div class="card-body p-4"> 
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            ...
                                            <div class="mb-3 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                                <div class="float-end">
                                                    <a href="auth-pass-reset-basic.php" class="text-muted">Has olvidado la contraseña?</a>
                                                </div>
                                            ...
                                            <!-- <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="auth-remember-check">Recordar usuario</label>
                                            </div> -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> InventFlow-Company</p>
                            </div>
                        </div>
                    </div>
                </div>
